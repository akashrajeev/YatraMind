...
async def run_optimization(
    ...
    try:
        ...
        note = None if fleet_req.required_service_trains <= granted else (
            f"Optimization granted {granted} trains, fewer than required {fleet_req.required_service_trains}."
        )
        return {
            "required_service_trains": fleet_req.required_service_trains,
            "standby_buffer": fleet_req.standby_buffer,
